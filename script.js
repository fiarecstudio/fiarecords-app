...
const API_URL = 'http://localhost:5000';
    ...
    async function guardarEdicionArtista(e) {
        ...
        try { await fetchAPI(`/api/artistas/${id}`, { method: 'PUT', body: JSON.stringify(body) }); showToast('Datos actualizados.', 'success'); 
    ...
    function renderSidebar(user) {
        ...
        document.querySelectorAll('.nav-link-sidebar').forEach(link => { link.addEventListener('click', (e) => mostrarSeccion(e.currentTarget.dataset.seccion)); });
    }
