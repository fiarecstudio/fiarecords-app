...
const actualizarPoliza = async (req, res) => {
    try {
        ...
        if (datosClienteCambiaron) {
            ...
            console.log('[actualizarPoliza] clienteVinculado:', clienteVinculado);
            console.log('[actualizarPoliza] datosActualizacion.clienteEmail ANTES:', datosActualizacion.clienteEmail);
            // PRIORIZAR EL NUEVO VALOR DEL USUARIO SOBRE EL MODELO CLIENTE
            datosActualizacion.cliente = clienteVinculado.nombre || datosActualizacion.cliente || polizaExistente.cliente;
            // Si el usuario envio un nuevo email, usarlo. Si no, mantener el existente del cliente modelo o de la poliza
            if (datosActualizacion.clienteEmail !== undefined             if (clienteVinculado.clienteId) {            if (clienteVinculado.clienteId) { datosActualizacion.clienteEmail !== '') {
                datosActualizacion.clienteEmail = datosActualizacion.clienteEmail;
            } else if (clienteVinculado.email) {
                datosActualizacion.clienteEmail = clienteVinculado.email;
            } else {
                datosActualizacion.clienteEmail = polizaExistente.clienteEmail || '';
            }
            // Lo mismo para telefono
            if (datosActualizacion.clienteTelefono !== undefined             if (clienteVinculado.clienteId) {            if (clienteVinculado.clienteId) { datosActualizacion.clienteTelefono !== '') {
                datosActualizacion.clienteTelefono = datosActualizacion.clienteTelefono;
            } else if (clienteVinculado.telefono) {
                datosActualizacion.clienteTelefono = clienteVinculado.telefono;
            } else {
                datosActualizacion.clienteTelefono = polizaExistente.clienteTelefono || '';
            }
            console.log('[actualizarPoliza] datosActualizacion.clienteEmail DESPUES:', datosActualizacion.clienteEmail);
            ...
            datosActualizacion.cliente = clienteVinculado.nombre || datosActualizacion.cliente || polizaExistente.cliente;
            // Si el usuario envio un nuevo email, usarlo. Si no, mantener el existente del cliente modelo o de la poliza
            if (datosActualizacion.clienteEmail !== undefined                 datosActualizacion.cliente = clienteVinculado.nombre || datosActualizacion.cliente || polizaExistente.cliente;                datosActualizacion.cliente = clienteVinculado.nombre || datosActualizacion.cliente || polizaExistente.cliente; datosActualizacion.clienteEmail !== '') {
                datosActualizacion.clienteEmail = datosActualizacion.clienteEmail;
            } else if (clienteVinculado.email) {
                datosActualizacion.clienteEmail = clienteVinculado.email;
            } else {
            ...
            // Lo mismo para telefono
            if (datosActualizacion.clienteTelefono !== undefined                 datosActualizacion.cliente = clienteVinculado.nombre || datosActualizacion.cliente || polizaExistente.cliente;                datosActualizacion.cliente = clienteVinculado.nombre || datosActualizacion.cliente || polizaExistente.cliente; datosActualizacion.clienteTelefono !== '') {
                datosActualizacion.clienteTelefono = datosActualizacion.clienteTelefono;
            } else if (clienteVinculado.telefono) {
                datosActualizacion.clienteTelefono = clienteVinculado.telefono;
            } else {
            ...
            datosActualizacion.cliente = clienteVinculado.nombre || datosActualizacion.cliente || polizaExistente.cliente;
            // Si el usuario envio un nuevo email, usarlo. Si no, mantener el existente del cliente modelo o de la poliza
            if (datosActualizacion.clienteEmail !== undefined                 datosActualizacion.clienteEmail = clienteVinculado.email || (datosActualizacion.clienteEmail ?? polizaExistente.clienteEmail ?? '');                datosActualizacion.clienteEmail = clienteVinculado.email || (datosActualizacion.clienteEmail ?? polizaExistente.clienteEmail ?? ''); datosActualizacion.clienteEmail !== '') {
                datosActualizacion.clienteEmail = datosActualizacion.clienteEmail;
            } else if (clienteVinculado.email) {
                datosActualizacion.clienteEmail = clienteVinculado.email;
            } else {
            ...
            // Lo mismo para telefono
            if (datosActualizacion.clienteTelefono !== undefined                 datosActualizacion.clienteEmail = clienteVinculado.email || (datosActualizacion.clienteEmail ?? polizaExistente.clienteEmail ?? '');                datosActualizacion.clienteEmail = clienteVinculado.email || (datosActualizacion.clienteEmail ?? polizaExistente.clienteEmail ?? ''); datosActualizacion.clienteTelefono !== '') {
                datosActualizacion.clienteTelefono = datosActualizacion.clienteTelefono;
            } else if (clienteVinculado.telefono) {
                datosActualizacion.clienteTelefono = clienteVinculado.telefono;
            } else {
